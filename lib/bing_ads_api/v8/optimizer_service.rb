...
#
# Code generated by AdsCommonBing library 0.7.3 on 2012-07-04 16:50:31.

require 'ads_common_bing_for_bing_ads/savon_service'
require 'bing_ads_api/v8/optimizer_service_registry'

module BingAdsApi; module V8; module OptimizerService
  class OptimizerService < AdsCommonBingForBingAds::SavonService
    ...
    def get_module()
      return BingAdsApi::V8::OptimizerService
    end
  end
end; end; end
