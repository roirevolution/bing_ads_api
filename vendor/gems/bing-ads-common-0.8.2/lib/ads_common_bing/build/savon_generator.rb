...
require 'ads_common_bing/build/savon_service_generator'
require 'ads_common_bing/build/savon_registry'
require 'ads_common_bing/build/savon_registry_generator'
    ...
    class SavonGenerator
      ...
      def check_service(wsdl)
        if wsdl.endpoint.nil? || wsdl.namespace.nil?
          raise AdsCommonBing::Errors::BuildError,
