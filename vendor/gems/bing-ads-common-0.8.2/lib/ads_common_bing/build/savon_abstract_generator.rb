...
module AdsCommonBing
  module Build
    class SavonAbstractGenerator
      def initialize(args)
        if self.class() == AdsCommonBing::Build::SavonAbstractGenerator
      ...
      def prepare_template_strings()
        @generator_stamp = "Code generated by AdsCommonBing library %s on %s." %
            [AdsCommonBing::ApiConfig::CLIENT_LIB_VERSION,
