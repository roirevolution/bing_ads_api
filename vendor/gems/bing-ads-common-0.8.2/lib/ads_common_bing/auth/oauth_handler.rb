...
require 'ads_common_bing/auth/base_handler'
...
module AdsCommonBing
  module Auth
    ...
    class OAuthHandler < AdsCommonBing::Auth::BaseHandler
      OAUTH_CONFIG = {
      ...
      #
      # Raises:
      # - AdsCommonBing::Errors::AuthError if validation fails
      #
      def validate_credentials(credentials)
        if @scope.nil?
          raise AdsCommonBing::Errors::AuthError, 'Scope is not specified.'
        end

        if credentials.nil?
          raise AdsCommonBing::Errors::AuthError, 'No credentials supplied.'
        end
      ...
      #
      # Raises:
      # - AdsCommonBing::Errors::AuthError if authentication fails
      # - AdsCommonBing::Errors::OAuthVerificationRequired if OAuth verification
      #   code required
      #
