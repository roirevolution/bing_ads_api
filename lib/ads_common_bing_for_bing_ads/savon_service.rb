...
class AdsCommonBingForBingAds::SavonService < AdsCommonBing::SavonService

  private

  # [CHANGES: 
  # => ParametersValidator to AdsCommonBingForBingAds::ParametersValidator
  # => ResultsExtractor    to AdsCommonBing::ResultsExtractor]
  # Executes SOAP action specified as a string with given arguments.
    def execute_action(action_name, args, &block)
      registry = get_service_registry()
      validator = AdsCommonBingForBingAds::ParametersValidator.new(registry)
  ...
  #
  def prepend_namespace(str, namespace = AdsCommonBingForBingAds::SavonHeaders::BaseHeaderHandler::DEFAULT_NAMESPACE)
  ...
  def execute_soap_request(action, args, extra_namespaces)
    ns = AdsCommonBingForBingAds::SavonHeaders::BaseHeaderHandler::DEFAULT_NAMESPACE
  ...
  def create_savon_client(endpoint, namespace)
    ...
    client = Savon::Client.new do |wsdl, httpi|
      ...
      AdsCommonBingForBingAds::Http.configure_httpi(@config, httpi)
    end
  ...
  def exception_for_soap_fault(response)
    begin
      ...
      # Specific to Bing Ads (ad api)
        ...
        return AdsCommonBingForBingAds::Errors::ApiException.new(
